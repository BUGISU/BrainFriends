...
> = {
  // home
  텔레비전: { hint: "방송을 보는 가전", category: "가전", strokes: 23 },
  냉장고: { hint: "음식을 차갑게 보관하는 곳", category: "가전", strokes: 16 },
  거울: { hint: "얼굴을 보는 물건", category: "생활", strokes: 10 },
  시계: { hint: "시간을 확인하는 물건", category: "생활", strokes: 10 },
  소파: { hint: "앉아서 쉬는 가구", category: "가구", strokes: 11 },
  숟가락: { hint: "밥을 떠먹는 도구", category: "주방", strokes: 21 },
  젓가락: { hint: "음식을 집는 도구", category: "주방", strokes: 20 },
  컵: { hint: "음료를 담는 용기", category: "용기", strokes: 4 },
  ...
  베개: { hint: "머리를 받치고 자는 것", category: "침구", strokes: 9 },

  // hospital
  붕대: { hint: "상처를 감싸는 천", category: "의료", strokes: 14 },
  주사기: { hint: "약물을 주입하는 도구", category: "의료", strokes: 10 },
  반창고: { hint: "상처에 붙이는 것", category: "의료", strokes: 16 },
  실내화: { hint: "병실에서 신는 신발", category: "생활", strokes: 16 },
  옷걸이: { hint: "옷을 거는 물건", category: "생활", strokes: 15 },
  마스크: { hint: "코와 입을 가리는 것", category: "위생", strokes: 12 },
  ...
  체온계: { hint: "체온을 재는 도구", category: "의료", strokes: 15 },
  휠체어: { hint: "환자를 옮기는 의자", category: "의료", strokes: 18 },

  // cafe
  커피: { hint: "향이 나는 대표 음료", category: "음료", strokes: 8 },
  케이크: { hint: "달콤한 디저트", category: "디저트", strokes: 13 },
  쿠키: { hint: "작고 바삭한 과자", category: "디저트", strokes: 8 },
  빵: { hint: "밀가루로 만든 음식", category: "식품", strokes: 9 },
  샌드위치: { hint: "빵 사이에 재료를 넣은 음식", category: "식품", strokes: 23 },
  주스: { hint: "과일로 만든 음료", category: "음료", strokes: 8 },
  차: { hint: "따뜻하게 마시는 음료", category: "음료", strokes: 4 },
  아이스크림: { hint: "차갑고 달콤한 디저트", category: "디저트", strokes: 27 },
  커피머신: { hint: "커피를 추출하는 기계", category: "가전", strokes: 20 },
  메뉴판: { hint: "음식과 가격을 보는 판", category: "용품", strokes: 13 },
  포크: { hint: "음식을 찍어 먹는 도구", category: "식기", strokes: 9 },
  테이블: { hint: "음식을 놓는 가구", category: "가구", strokes: 15 },

  // bank
  지폐: { hint: "종이로 된 돈", category: "금융", strokes: 9 },
  동전: { hint: "금속으로 된 돈", category: "금융", strokes: 10 },
  ...
  펜: { hint: "글씨를 쓰는 도구", category: "문구", strokes: 4 },
  ...
  벤치: { hint: "앉아서 쉬는 곳", category: "시설", strokes: 11 },
  강아지: { hint: "사람과 함께 사는 동물", category: "동물", strokes: 16 },
  자전거: { hint: "두 바퀴로 타는 것", category: "이동", strokes: 15 },
  ...
  쓰레기통: { hint: "쓰레기를 버리는 통", category: "시설", strokes: 24 },
  분수: { hint: "물이 솟아오르는 곳", category: "시설", strokes: 11 },
  운동화: { hint: "걷거나 뛸 때 신는 신발", category: "의류", strokes: 17 },
  ...
  카트: { hint: "물건을 싣고 미는 바퀴 달린 도구", category: "용품", strokes: 7 },
  바구니: { hint: "물건을 담는 용기", category: "용품", strokes: 12 },
  ...
  생선: { hint: "물속에 사는 동물", category: "식품", strokes: 10 },
};
